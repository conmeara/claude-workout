...
*Each day gets one file. Workouts and conversation context live together.*
...
On rest days or non-training conversations, skip the Workout section. Not every day needs one.

Additional training files:
- `program.md` — Current training plan (read every session)
- `USER.md` — Includes Active Adjustments and Personal Records sections
